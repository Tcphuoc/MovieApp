...
export default function SignupPage() {
  const [authData, setAuthData] = useState<SignupForm>(DEFAULT_SIGNUP_FORM);
  ...
  async function authHandler(formData: FormData) {
    const errors: SignupError = { ...DEFAULT_ERROR };
    const data: SignupData = { ...DEFAULT_DATA };
  ...
  return <section>
    ...
    <div className="bg-black w-130 py-15 px-20 mx-auto rounded-md">
      ...
      <form action={authHandler}>
        ...
        />
        <CustomButton className="btn-primary w-full mb-5" type="submit">Sign up</CustomButton>
      </form>
      <div className="flex">
